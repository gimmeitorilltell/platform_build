...
include $(BUILD_SYSTEM)/candy_config.mk
...
TARGET_GLOBAL_CFLAGS += $(COMMON_GLOBAL_CFLAGS) $(CANDY_GLOBAL_CFLAGS)
TARGET_RELEASE_CFLAGS += $(COMMON_RELEASE_CFLAGS) $(CANDY_RELEASE_CFLAGS)

TARGET_GLOBAL_CPPFLAGS += $(COMMON_GLOBAL_CPPFLAGS) $(CANDY_GLOBAL_CFLAGS)
TARGET_RELEASE_CPPFLAGS += $(COMMON_RELEASE_CPPFLAGS) $(CANDY_RELEASE_CFLAGS)
